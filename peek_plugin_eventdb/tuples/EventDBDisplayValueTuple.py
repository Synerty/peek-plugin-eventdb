...
@addTupleType
class EventDBDisplayValueTuple(Tuple):
    """ Live DB Display Value Tuple

    This tuple stores a value of a key in the Live DB database.

    """
    __tupleType__ = eventdbTuplePrefix + 'EventDBDisplayValueTuple'
    ...
    def sqlCoreLoad(cls, row):
        return EventDBDisplayValueTuple(key=row.key, dataType=row.dataType,
